...
Este proyecto fue realizado para la clase de UX-UI (Graficos interfaces y usabilidad) en donde se planteo realizar una calculadora automotriz para distintos caso de uso referentes a automobiles.
...
├── frontend/
│   ├── index.html            #  HTML, cableado a la API
│   └── assets/
...
El proyecto es completamente funcional sin llaves ni APIs externas. Para futuras actualizaciones pense en:
